    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-900 via-primary-800 to-accent-800 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-playfair font-bold text-white mb-2">Student Portal</h1>
        ...
        >
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <div className="text-center">
              <p className="text-sm text-gray-600 mb-3">Not enrolled yet?</p>
              <a
                href="/courses"
        ...
        >
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
            ...
            <p className="text-white/80 text-xs">Email: ahmed.ibrahim@example.com</p>
